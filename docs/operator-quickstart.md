# Operator Quickstart — Motion Picture Projection Activities

Shortest path from clone to a verified local dry-run for **ISIC 5914** (`cloud-itonami-isic-5914`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5914.git
cd cloud-itonami-isic-5914
```
...
- Blueprint governor key: `cinema-ops-governor`
- Likely source path: `cinemaops.governor.cljc`
